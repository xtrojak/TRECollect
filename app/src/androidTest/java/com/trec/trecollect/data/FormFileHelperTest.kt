...
import com.trec.trecollect.data.FormData
import com.trec.trecollect.data.FormFieldValue
...
class FormFileHelperTest {
    ...
    fun tearDown() {
        ...
        try {
            formFileHelper.deleteForm(testSiteName, testFormId, orderInSection = 0, subIndex = null)
        } catch (e: Exception) {
